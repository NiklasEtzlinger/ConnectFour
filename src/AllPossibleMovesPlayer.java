 ...
 *          of the possible moves. It makes the move that gives it the best
 *          strength.
 *
 *          You can give the allPossibleMoves a number from 0 to 1, which
 *          represents the proportion of the moves that it tries. The default is
 *          1, try all moves. The player will always return a move if their are
 *          moves to be made.
 */
...
//-----------------------------------------
   ...
   * Creates new AllPossibleMovesPlayer
   *
   * fractionOfMovesTried represents the fraction of moves that the player will
   * try. Should be a double from 0 to 1. If 0 the player will return a move at
   * random from the possible moves.
   */
...
//-----------------------------------------
  ...
  /**
   * Tries fractionOfMovesTried moves. Throws an ArrayIndexOutOfBoundsException if
   * the board returns no possible moves.
   */
